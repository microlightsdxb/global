...
const Settings = () => {
  ...
  return (
    <div className='grid grid-cols-2 gap-5'>
        <div className='flex flex-col gap-5 border-r border-r-gray-300 pr-5'>
            <Label className='text-md font-bold border-b-2 border-gray-300'>Meta Section</Label>
        ...
        <Label className='text-md font-bold border-b-2 border-gray-300'>Change Password</Label>
            {!currentPasswordIsCorrect ? (<form className='flex flex-col gap-5'>
                        <div className="space-y-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <Button type="button" className='w-full cursor-pointer' onClick={checkCurrentPassword}>Continue</Button>
                        </div>
                    </form>) 
                    ...
                    (<form className='flex flex-col gap-5'>
                        ...
                        <div className="flex flex-col">
                            ...
                            <Button type="button" className='w-full cursor-pointer' onClick={submitNewPassword}>Confirm</Button>
                        </div>
                    </form>)
