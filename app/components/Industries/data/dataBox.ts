...
export const consultationData = [
    ...
    {
      id: 1,
      title: "Consultation with Our Sales Team",
      description:
    ...
    {
      id: 2,
      title: "Tailor Made Solutions by Our Lighting Designers",
      description:
    ...
    {
      id: 3,
      title: "Factory and Warehouse Logistics",
      description:
    ...
    {
      id: 4,
      title: "Professional On-Site Visits and Advice",
      description:
    ...
    {
      id: 5,
      title: "Ongoing After-Care Support",
      description:
