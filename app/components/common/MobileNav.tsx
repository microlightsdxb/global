...
const MobileNav = () => {
    ...
    const actualPath = "456.851,0 245,212.564 33.149,0 0.708,32.337 212.669,245.004 0.708,457.678 33.149,490 245,277.443 456.851,490 489.292,457.678 277.331,245.004 489.292,32.337 "

    const handleClose = () => {
        const finalPath = "50,150 440,150 440,190 50,190 50,300 440,300 440,340 50,340"
        if (pathRef.current) {
            gsap.to(pathRef.current, {
                attr: { points: finalPath },
                duration: .5, // Adjust duration for smooth animation
                onComplete: () => {
    ...
    return (
        <>
            {/* Navbar */}
            <nav className="w-full bg-transparent text-white tanspheader py-4 absolute top-0 z-10 lg:hidden">
            ...
            <Link href="/">
              ...
              />
                    ...
                    {/* Hamburger Button */}
                    <div
                        className="cursor-pointer px-2 py-2 z-50 bg-white rounded-full top-5 absolute"
                        onClick={handleMenuOpen}>
                        <svg fill="#000000" height="30px" width="30px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490 490">
                        ...
                        onClick={handleClose}>
                            ...
                            <svg fill="#000000" height="30px" width="30px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                                ...
                                <polygon points="456.851,0 245,212.564 33.149,0 0.708,32.337 212.669,245.004 0.708,457.678 33.149,490 245,277.443 456.851,490 
                                    489.292,457.678 277.331,245.004 489.292,32.337 "  ref={pathRef}/>
                            </svg>
