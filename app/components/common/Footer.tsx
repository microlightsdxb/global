        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8"   >
          ...
          <motion.div className="" initial={{ opacity: 0, y: -50 }}
            ...
            <div className="flex justify-between items-center bg-primary p-[20px] lg:p-[25px] 2xl:p-[35px] mb-[30px] lg:mb-[90px]">
              ...
              <div className="flex">
                <BrochureDownloadModal>
                  <button className="flex gap-[20px] items-center cursor-pointer border-t border-white text-sm text-white border-solid leaing-none pt-[12px] hover:text-gray-300 transition-colors">
            ...
            <div className="text-primary/50 text-center mt-6 text-[13px] flex justify-between">
              <p>&copy;{new Date().getFullYear()} Lighting Solutions Dubai - microlights.com. All rights reserved </p>
