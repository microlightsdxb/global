...
/* 
  ...
  return (
    <>
    <section className="section-spacing relative text-white h-[170vh] lg:h-[150vh] overflow-hidden">
        ...
        <div className="container">
          ...
          <div className="bomsx grid grid-cols-1 lg:grid-cols-3 ">
            {industies.map((industry, i) => (
              ...
              custom={i}
              className="bitms p-[20px] lg:p-[50px] border-r border-b border-[#595959] border-l border-t relative overflow-hidden group cursor-pointer"  key={i}>
                ...
                <Image src={industry.icon} width={100} height={75} className="w-auto mb-[40px] lg:mb-[90px] z-[10] relative h-[55px] lg:h-[75px]" alt={industry.name}/>
