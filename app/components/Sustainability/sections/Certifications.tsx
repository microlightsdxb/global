  ...
  return (
    <section className="py-100 bg-[#F1F6F0]">
      <div className="container">
        <h2 className="text-xl text-black leading-[1.3] mb-4 md:mb-12">
          Certifications & Standards
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2  border border-[#00000015]">
          <div className="p-5 md:p-10 border-r border-[#00000015]">
          ...
          <div className="p-5 md:p-10">
            ...
            <div className="pt-8">
              <h4 className="text-lg text-black mb-5 leading-[1.2]">
              KUCAS & SASO Certification
              </h4>
              <p className="text-[#555555] font-[300] leading-[1.7]">
              Ensuring our products meet stringent regional
              </p>
            </div>
          </div>
        </div>
